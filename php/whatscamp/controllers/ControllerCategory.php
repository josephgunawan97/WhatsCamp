...
{ 
    ...
    public function updateCategory($itm) 
    {
        ...
        $stmt = $this->pdo->prepare('UPDATE tbl_whatscamp_categories 
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_whatscamp_categories( 
                                            category,
                                            category_icon,
                                            created_at,
                                            updated_at ) 
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                        FROM tbl_whatscamp_categories WHERE category_id = :category_id');
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                        FROM tbl_whatscamp_categories WHERE category = :category');
    ...
    {
        $stmt = $this->pdo->prepare('SELECT tbl_whatscamp_categories.category_id,
                                            tbl_whatscamp_categories.category,
                                            tbl_whatscamp_categories.category_icon,
                                            tbl_whatscamp_categories.created_at,
                                            tbl_whatscamp_categories.updated_at,
                                            tbl_whatscamp_categories.is_deleted  
                                FROM tbl_whatscamp_categories 
                                INNER JOIN tbl_whatscamp_event_categories ON
                                tbl_whatscamp_categories.category_id = tbl_whatscamp_event_categories.category_id 
                                 WHERE tbl_whatscamp_categories.is_deleted = 0 AND tbl_whatscamp_event_categories.is_deleted = 0 AND tbl_whatscamp_event_categories.event_id = :event_id ORDER BY category ASC');
