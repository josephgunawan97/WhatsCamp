...
class ControllerUser
{
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_whatscamp_users( 
                                        full_name,
                                        login_hash, 
                                        facebook_id,
                                        twitter_id,
    ...
    {
        $stmt = $this->pdo->prepare('UPDATE tbl_whatscamp_users
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * FROM tbl_whatscamp_users 
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                FROM tbl_whatscamp_users ORDER BY full_name ASC');
