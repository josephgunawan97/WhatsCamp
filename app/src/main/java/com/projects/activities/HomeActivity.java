...
import com.projects.events.EventAddActivity;
import com.projects.events.EventEditActivity;
    ...
    public void getData() {
        ...
        task.setMGAsyncTaskListener(new MGAsyncTaskNoDialog.OnMGAsyncTaskListenerNoDialog() {
            ...
            public void onAsyncTaskDoInBackground(MGAsyncTaskNoDialog asyncTask) {
                ...
                UserSession userSession = UserAccessSession.getInstance(HomeActivity.this).getUserSession();
                if(GlobalApplication.currentLocation!= null) {
                    try {
                        float radius = UserAccessSession.getInstance(HomeActivity.this).getFilterDistance();
                        if(radius == 0)
        ...
        adapter.setOnMGRecyclerAdapterListener(new MGRecyclerAdapter.OnMGRecyclerAdapterListener() {
            ...
            public void onMGRecyclerAdapterCreated(MGRecyclerAdapter adapter, MGRecyclerAdapter.ViewHolder v, int position) {
                ...
                if(event.getPhoto_url() != null) {
                    GlobalApplication.getImageLoaderInstance(HomeActivity.this)
                            .displayImage(
                                    event.getPhoto_url(),
                                    imgViewThumb,
                ...
                tvEdit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        // TODO Auto-generated method stub
                        Intent i = new Intent(HomeActivity.this, EventEditActivity.class);
                        i.putExtra("event", event);
                ...
                String strDistance = String.format("%.1f %s",
                        event.getDistance(),
                        MGUtilities.getStringFromResource(HomeActivity.this, R.string.km));

                tvDistance.setText(strDistance);

                String strGoing = String.format("%d %s",
                        event.getAttendees_total(),
                        MGUtilities.getStringFromResource(HomeActivity.this, R.string.going));
